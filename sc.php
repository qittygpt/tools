...
echo '<div class="card">';
echo '<h5 class="card-header border-bottom text-uppercase"><center>SCANNER BACKDOOR TKP GROUP</center></h5>';
echo '<center> <img src="https://i.ibb.co.com/cKxLptsd/tkp-removebg-preview.png"> </center> ';
